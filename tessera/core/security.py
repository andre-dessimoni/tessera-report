...
# *inline* code and ``data:`` URIs — never an external origin — because tessera
...
class Security:
    ...
    Attributes:
        ...
        csp: **Advanced.** Supply your own Content-Security-Policy string to take
            full control of what the page may load. Overrides the policy tessera
            would generate.
    """
